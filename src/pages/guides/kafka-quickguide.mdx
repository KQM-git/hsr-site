...
import { Troll, Priority } from "../../components/mdx/Guide.tsx";
...
<Priority.Table>
  <Priority.Item
    name="Ultimate"
    image="/kafka-quick-guide/Ability_Twilight_Trill.webp"
  />
  <Priority.Arrow />
  <Priority.Item
    name="Skill"
    image="/kafka-quick-guide/Ability_Caressing_Moonlight.webp"
  />
  <Priority.Arrow />
  <Priority.Item
    name="Talent"
    image="/kafka-quick-guide/Ability_Gentle_but_Cruel.webp"
  />
  <Priority.Arrow />
  <Priority.Item
    name="Basic"
    image="/kafka-quick-guide/Ability_Midnight_Tumult.webp"
  />
</Priority.Table>
...
<Priority.Table>
  <Priority.Item name="A2" image="/kafka-quick-guide/Trace_Torture.webp" />
  <Priority.Arrow />
  <Priority.Item name="A6" image="/kafka-quick-guide/Trace_Thorns.webp" />
  <Priority.Arrow />
  <Priority.Item name="A4" image="/kafka-quick-guide/Trace_Plunder.webp" />
</Priority.Table>
